...
public class MkopoDaoImpl extends AbstractDaoImpl implements MkopoDao {
	...
	public List<Mkopo> tafutaMikopo(MultivaluedMap<String, String> filters) {
		...
		try {
			...
			tengenezaVigezoVyaMkopo(filters, values, queryFilters, queryParams);
	...
	private void tengenezaVigezoVyaMkopo(MultivaluedMap<String, String> filters, List<Object> values,
			List<String> queryFilters, List<String> queryParams) {
	...
	public List<OmbiLaMkopo> tafutaOmbiLaMkopo(MultivaluedMap<String, String> filters) {
		...
		try {
			...
			tengenezaVigezo(filters, values, queryFilters, queryParams);
	...
	private void tengenezaVigezo(MultivaluedMap<String, String> filters, List<Object> values, List<String> queryFilters,
