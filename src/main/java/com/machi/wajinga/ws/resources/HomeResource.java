...
public class HomeResource {
	...
	public Response tengenezaNywiraMpya(@PathParam("barua-pepe") String baruaPepe) {
		...
		String linki = wajiboostDao.tafutaUsanidi(Usanidi.SEVA) + "/mjinga/tengeneza-nywira-mpya/" + tokeni + "/"
				+ baruaPepe + "/";
		hudumaYaBaruaPepe.tuma(emails, null, wajiboostDao.tafutaUsanidi(Usanidi.BADILI_NYWIRA),
				String.format(Usanidi.BADILI_NYWIRA_MESEJI, linki), null);
		return Response.noContent().build();
	}
	...
	public Response tengenezaNywiraMpya(@PathParam("tokeni") String tokeni, @PathParam("barua-pepe") String baruaPepe) {
		...
		return Response.ok().entity(
				"<div> Nywira yako mpya ni: <strong>" + nywiraMpya + " </strong> <br> Kumbuka badili hii nywira.</div>")
				.build();
	}
