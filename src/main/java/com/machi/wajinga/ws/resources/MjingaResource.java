...
public class MjingaResource {
    ...
    public Response ongezaMjinga(Mjinga mjinga) {
		...
		Mjinga mjinga_ = tafutaMjingaKwaJina != null ? tafutaMjingaKwaJina : dao.tafutaMjingaKwaBaruaPepe(mjinga.getBaruaPepe());
		...
		hudumaYaBaruaPepe.tuma(Arrays.asList(mjinga.getBaruaPepe()), null, wajiboostDao.tafutaUsanidi(Usanidi.AKAUNTI_KUFUNGULIWA), String.format(wajiboostDao.tafutaUsanidi(Usanidi.AKAUNTI_KUFUNGULIWA_MESEJI), mjinga.getJina(), DateTime.now(), nywiraMpya), null);
    ...
    public Response banChaMjinga(@PathParam("jina") String jinaLaMjinga) {
		...
		hudumaYaBaruaPepe.tuma(Arrays.asList(mjinga.getBaruaPepe()), null, subject, String.format(meseji, mjinga.getJina(), DateTime.now()), null);
